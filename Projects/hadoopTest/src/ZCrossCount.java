...
public class ZCrossCount extends Configured implements Tool {
    
    public static class MapClass extends MapReduceBase
        implements Mapper<Object, Text, Text, HMapSIW> {
    ...
    public int run(String[] args) throws Exception {
        ...
        JobConf job = new JobConf(conf, ZCrossCount.class);
    ...
    public static void main(String[] args) throws Exception { 
        int res = ToolRunner.run(new Configuration(), new ZCrossCount(), args);
